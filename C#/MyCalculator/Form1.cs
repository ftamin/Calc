...
namespace MyCalculator
{
    public partial class frmCalculator : Form
    {
        ...
        private void btnEqual_Click(object sender, EventArgs e)
        {
            ...
            {
                case '+':
                    result = calc.Add(opr1, opr2).ToString();
                    break;

                case '-':
                    result = calc.Minus(opr1, opr2).ToString();
                    break;

                case '*':
                    result = calc.Multiply(opr1, opr2).ToString();
                    break;

                case '/':
                    if (opr2 != 0)
                    {
                        result = calc.Divide(opr1, opr2).ToString();
                    }
                    else
                    {
        ...
        private void btnSqrRoot_Click(object sender, EventArgs e)
        {
            ...
            {
                txtInput.Text = calc.SqrtRoot(opr1).ToString();
            }
        }
        ...
        private void btnByTwo_Click(object sender, EventArgs e)
        {
            ...
            if (double.TryParse(txtInput.Text, out opr1))
            {
                txtInput.Text = calc.ByTwo(opr1).ToString();
            }
        }
        ...
        private void btnByFour_Click(object sender, EventArgs e)
        {
            ...
            if (double.TryParse(txtInput.Text, out opr1))
            {
                txtInput.Text = calc.ByFour(opr1).ToString();
            }
        }
    }
}
